...
//        Double[] weightsThresholds = new Double[] {1,2,3,4,5,6};
        
        Matrix l1_data = l3.getMatrix();
        
        int width = l1_data.getCols();
        int height = l1_data.getRows();
        
        for (int i=0;i<width;i++) {
            for (int j=0;j<height;j++) {
                System.out.println(i + " " + j + " = " + l1_data.get(j, i));
            }
        }
