...
import UnsupportedClass.UnsupportedOperationException;
...
public class Matrix implements EncogPersistedObject {
    ...
    /**
     * Random number generator used for this matrix sjb - added since Java ME
     * doesn't support Math.random() method
     */
    Random generator;
     ...
     *
     * @param sourceMatrix The booleans to create the matrix from.
     */
...
//        throw new UnsupportedOperationException("Persistence not supported in Java ME");
    }

    /**
     * Check to see if this matrix equals another, using default precision.
     *
     * @param matrix The other matrix to compare.
     ...
     *
     * @param matrix The other matrix to compare to.
